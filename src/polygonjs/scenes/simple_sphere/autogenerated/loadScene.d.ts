...
import { PolySceneWithNodeMap_simple_sphere } from "./PolySceneWithNodeMap";
...
export interface LoadedData {
  scene: PolySceneWithNodeMap_simple_sphere;
  viewer: BaseViewerType | undefined;
}
export type LoadScene_simple_sphere = (
  options?: LoadSceneOptions
) => Promise<LoadedData>;

export const loadScene_simple_sphere: LoadScene_simple_sphere;
