...
export class PolySceneWithNodeMap_simple_scene extends PolyScene {
  ...
  node(path: "/ground/ground_box1"): BoxSopNode;
  node(path: "/ground/MAT"): MaterialsNetworkSopNode;
  node(path: "/ground/MAT/meshStandardBuilder1"): MeshStandardBuilderMatNode;
  node(path: "/ground/merge1"): MergeSopNode;
  node(path: "/ground/polynode_avatar/attribCreate1"): AttribCreateSopNode;
  node(path: "/ground/polynode_avatar/subnetOutput1"): SubnetOutputSopNode;
  node(path: "/ground/polynode_avatar/transform1"): TransformSopNode;
  node(path: "/ground/polynode_avatar/box1_avatar"): BoxSopNode;
  node(path: "/ground/polynode_avatar/subnetOutput2"): SubnetOutputSopNode;
...
export interface PolySceneProps_simple_scene {
  ...
  "ground-ground_box1--size"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--sizes"?: ParamValueSerializedTypeMap["vector3"];
  "ground-ground_box1--sizes-sizesx"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--sizes-sizesy"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--sizes-sizesz"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--sizesx"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--sizesy"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--sizesz"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--divisions"?: ParamValueSerializedTypeMap["vector3"];
  "ground-ground_box1--divisions-divisionsx"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--divisions-divisionsy"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--divisions-divisionsz"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--divisionsx"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--divisionsy"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--divisionsz"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--center"?: ParamValueSerializedTypeMap["vector3"];
  "ground-ground_box1--center-centerx"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--center-centery"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--center-centerz"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--centerx"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--centery"?: ParamValueSerializedTypeMap["float"];
  "ground-ground_box1--centerz"?: ParamValueSerializedTypeMap["float"];
  ...
  "ground-merge1--compact"?: ParamValueSerializedTypeMap["boolean"];
  "ground-merge1--preserveMaterials"?: ParamValueSerializedTypeMap["boolean"];
  "ground-merge1--inputsCount"?: ParamValueSerializedTypeMap["integer"];
  "ground-polynode_avatar-attribCreate1--group"?: ParamValueSerializedTypeMap["string"];
  "ground-polynode_avatar-attribCreate1--class"?: ParamValueSerializedTypeMap["integer"];
  "ground-polynode_avatar-attribCreate1--type"?: ParamValueSerializedTypeMap["integer"];
  "ground-polynode_avatar-attribCreate1--name"?: ParamValueSerializedTypeMap["string"];
  "ground-polynode_avatar-attribCreate1--size"?: ParamValueSerializedTypeMap["integer"];
  "ground-polynode_avatar-attribCreate1--value1"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value2"?: ParamValueSerializedTypeMap["vector2"];
  "ground-polynode_avatar-attribCreate1--value2-value2x"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value2-value2y"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value2x"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value2y"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value3"?: ParamValueSerializedTypeMap["vector3"];
  "ground-polynode_avatar-attribCreate1--value3-value3x"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value3-value3y"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value3-value3z"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value3x"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value3y"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value3z"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value4"?: ParamValueSerializedTypeMap["vector4"];
  "ground-polynode_avatar-attribCreate1--value4-value4x"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value4-value4y"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value4-value4z"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value4-value4w"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value4x"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value4y"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value4z"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--value4w"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-attribCreate1--string"?: ParamValueSerializedTypeMap["string"];
  "ground-polynode_avatar-transform1--applyOn"?: ParamValueSerializedTypeMap["integer"];
  "ground-polynode_avatar-transform1--objectMode"?: ParamValueSerializedTypeMap["integer"];
  "ground-polynode_avatar-transform1--objectTransformSpace"?: ParamValueSerializedTypeMap["integer"];
  "ground-polynode_avatar-transform1--group"?: ParamValueSerializedTypeMap["string"];
  "ground-polynode_avatar-transform1--rotationOrder"?: ParamValueSerializedTypeMap["integer"];
  "ground-polynode_avatar-transform1--t"?: ParamValueSerializedTypeMap["vector3"];
  "ground-polynode_avatar-transform1--t-tx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--t-ty"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--t-tz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--tx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--ty"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--tz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--r"?: ParamValueSerializedTypeMap["vector3"];
  "ground-polynode_avatar-transform1--r-rx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--r-ry"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--r-rz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--rx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--ry"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--rz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--s"?: ParamValueSerializedTypeMap["vector3"];
  "ground-polynode_avatar-transform1--s-sx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--s-sy"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--s-sz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--sx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--sy"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--sz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--scale"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--pivot"?: ParamValueSerializedTypeMap["vector3"];
  "ground-polynode_avatar-transform1--pivot-pivotx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--pivot-pivoty"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--pivot-pivotz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--pivotx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--pivoty"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-transform1--pivotz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--size"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--sizes"?: ParamValueSerializedTypeMap["vector3"];
  "ground-polynode_avatar-box1_avatar--sizes-sizesx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--sizes-sizesy"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--sizes-sizesz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--sizesx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--sizesy"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--sizesz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--divisions"?: ParamValueSerializedTypeMap["vector3"];
  "ground-polynode_avatar-box1_avatar--divisions-divisionsx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--divisions-divisionsy"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--divisions-divisionsz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--divisionsx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--divisionsy"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--divisionsz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--center"?: ParamValueSerializedTypeMap["vector3"];
  "ground-polynode_avatar-box1_avatar--center-centerx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--center-centery"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--center-centerz"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--centerx"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--centery"?: ParamValueSerializedTypeMap["float"];
  "ground-polynode_avatar-box1_avatar--centerz"?: ParamValueSerializedTypeMap["float"];
